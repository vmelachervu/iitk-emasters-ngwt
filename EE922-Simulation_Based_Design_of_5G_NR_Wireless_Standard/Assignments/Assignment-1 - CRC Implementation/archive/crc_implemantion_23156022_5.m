...
calculatedCRC = calculate_5g_nr_crc(transport_block_bits_array,generatorPoly);
calculatedCRCString = sprintf('%d', calculatedCRC);
disp(['Calculated CRC bits are: ' calculatedCRCString]);
